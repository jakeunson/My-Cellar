    ...
    >
      ...
      <div className="bg-white px-4 py-3.5 border-b border-slate-200/80 flex items-center justify-between shrink-0 shadow-sm">
        ...
        <button
          ...
          className={`flex items-center space-x-1.5 px-3 py-2 rounded-xl text-xs font-bold border transition-all active:scale-95 ${
      ...
      <button
        ...
        className="absolute bottom-20 right-5 w-14 h-14 bg-slate-900 hover:bg-slate-800 active:scale-95 text-white rounded-2xl flex items-center justify-center shadow-xl hover:shadow-2xl transition-all border-2 border-slate-700 z-10"
      >
